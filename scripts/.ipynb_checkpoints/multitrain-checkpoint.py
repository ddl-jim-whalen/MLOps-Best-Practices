...
domino_project.job_start(command=('DOMINO_WORKING_DIR')+'/scripts/sklearn_model_train.py')

print('Kicking off R model training')
domino_project.job_start(command=('DOMINO_WORKING_DIR')+'scripts/R_model_train.R')


print('Kicking off h2o model training')
domino_project.job_start(command=('DOMINO_WORKING_DIR')+'scripts/h2o_model_train.py')
